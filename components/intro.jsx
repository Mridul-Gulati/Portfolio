...
const Intro = () => {
  ...
  return (
    ...
    >
      ...
      >
        Hello, I'm{" "}
        <span className="font-bold text-blue-500">Mridul Gulati</span>
        <br />
        <span className="text-xl sm:text-2xl font-normal text-gray-600 dark:text-gray-400">
          I'm a{" "}
          <span className="font-bold text-blue-400">Data Scientist</span>{" "}
          based in India. I love to work with data, gain insights and build models. I specialize in
          <br />
          <span className="font-bold text-blue-400">Python</span> and{" "}
      ...
      >
        ...
        <a
          href="https://drive.google.com/file/d/1fxOrAoEmpe5EiOvXuG6srqTlznMNB2gu/view?usp=drive_link"
          target="_blank"
        ...
        <a
          href="
          https://www.linkedin.com/in/mridul-gulati/
          "
          target="_blank"
          className="bg-gray-900 text-white px-5 py-3 flex items-center gap-2 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 hover:bg-gray-800 hover:scale-105 transition cursor-pointer"
        >
        ...
        <a
          href="
          https://github.com/Mridul-Gulati
        "
          target="_blank"
          className="bg-gray-900 text-white px-5 py-3 flex items-center gap-2 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 hover:bg-gray-800 hover:scale-105 transition cursor-pointer"
        >
